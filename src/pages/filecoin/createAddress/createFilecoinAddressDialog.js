...
import { PG } from '../../../filecoin/client';
import { Input, Button, Modal, ModalBody, Alert, FormGroup, Label, InputGroup } from 'reactstrap';
  ...
  render() {
    return (
      <Modal isOpen={this.props.show} toggle={this.props.onClose}>
        <ModalBody>
          <Widget className="widget-auth mx-auto" title={<h3 className="mt-0">Add Filecoin address</h3>}>
