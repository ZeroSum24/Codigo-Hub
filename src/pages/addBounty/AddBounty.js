...
class AddBounty extends React.PureComponent {
  ...
  handleAddBounty(e) {
    ...
    let newBounty = new Bounty(this.state.title,
            ...
            <FormGroup className="mt">
              ...
              <InputGroup className="input-group-no-border">
                <Input id="deviceType"
                       ...
                       onChange={this.changeDeviceBrand}
                       type="text"
            ...
            <FormGroup className="mt">
              ...
              <InputGroup className="input-group-no-border">
                <Input id="firmwareVersion"
                       ...
                       onChange={this.changeFirmwareVersion}
                       type="text"
                       required name="Firmware Version"
            ...
            <FormGroup className="mt">
              ...
              <InputGroup className="input-group-no-border">
                <Input id="ethAmount"
                       ...
                       type="text"
                       required name="Device Serial Number"
                       placeholder="E.g. 0.7"/>
              </InputGroup>
            </FormGroup>
