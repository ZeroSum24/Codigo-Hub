      ...
      <div>
        <div className="row progress-stats">
          <div className="col-md-9 col-12">
            ...
            <Progress color="success" value="33" className="bg-custom-dark progress-xs"/>
          </div>
          <div className="col-md-3 col-12 text-center">
                          <span className="status rounded rounded-lg bg-default text-light">
                            <small><AnimateNumber value={33}/>%</small>
                          </span>
          </div>
        </div>
        <div className="row progress-stats">
          <div className="col-md-9 col-12">
            ...
            <Progress color="warning" value="66" className="bg-custom-dark progress-xs"/>
          </div>
          <div className="col-md-3 col-12 text-center">
                          <span className="status rounded rounded-lg bg-default text-light">
                            <small><AnimateNumber value={66}/>%</small>
                          </span>
          </div>
        </div>
        <div className="row progress-stats">
