...
class Notifications extends React.Component {
	...
	launchNotification = (id) =>
		toast.update(id, { ...this.state.options, render: 'Thermonuclear war averted', type: toast.TYPE.SUCCESS });
	...
	retryNotification = (id) =>
		toast.update(id, { ...this.state.options, render: 'Alien planet destroyed!', type: toast.TYPE.SUCCESS });
				...
				<Widget title={<h6> Messenger </h6>} close collapse settings>
					<Row>
						<Col lg="4" xs="12">
							...
							<p>
								There are few position options available for notifications. You can click any of them to
						...
						<Col lg="4" xs="12">
							...
							<p>
								Different types of notifications for lost of use cases. Custom classes are also
								supported.
							</p>
							<p>
								<Button color="info" id="show-info-message" onClick={this.addInfoNotification}>
									Info Message
								</Button>
							</p>
							<p>
								<Button color="danger" id="show-error-message" onClick={this.addErrorNotification}>
									Error + Retry Message
								</Button>
							</p>
							<p>
								<Button color="success" id="show-success-message">
									Success Message
								</Button>
							</p>
						</Col>
						...
						<Col lg="4" xs="12">
							...
							<p>
								Just few lines of code to instantiate a notifications object. Does not require passing
								any options:
							</p>
